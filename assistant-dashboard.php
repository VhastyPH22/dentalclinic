...
$displayFirstName = explode(' ', $fullName)[0];
...
$profileQuery = mysqli_query($conn, "SELECT profile_picture FROM patient_profiles WHERE user_id = '$staffID'" . getTenantFilter());
...
$sql_new = "SELECT id FROM users WHERE role = 'patient' AND date(created_at) = '$today'" . getTenantFilter();
...
<head>
    ...
    <meta charset="utf-8"/>
    <title>Assistant Dashboard - <?php echo htmlspecialchars($clinicName); ?></title>
        ...
        <div class="p-6 md:p-10 max-w-[1600px] mx-auto flex flex-col gap-6 md:gap-10 animate-fade-in text-slate-900 dark:text-white">
            <header class="flex flex-col md:flex-row md:items-center justify-between gap-6 animate-fade-in">
                ...
                <div class="flex items-center gap-4">
                    <div class="text-right hidden sm:block">
                        <p class="text-sm font-bold"><?php echo date('l, M jS'); ?> at <span class="text-primary font-bold"><?php echo date('h:i A'); ?></span></p>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 font-bold">
                ...
                <div class="bg-white dark:bg-slate-800 p-6 md:p-8 rounded-[24px] border border-slate-200 dark:border-slate-700 shadow-sm shadow-md transition-all hover:scale-[1.02]">
                    ...
                    <h3 class="text-3xl md:text-4xl font-black mt-1 tracking-tight text-red-500">₱<?php echo number_format($countBillings, 2); ?></h3>
                </div>
