...
$payConditions = "DATE(CONVERT_TZ(p.payment_date, '+00:00', '+08:00')) BETWEEN '" . mysqli_real_escape_string($conn, $fromDate) . "' AND '" . mysqli_real_escape_string($conn, $toDate) . "'";
...
// Convert UTC timestamps to Manila timezone (UTC+8) before filtering
$treatConditions = "DATE(CONVERT_TZ(tr.treatment_date, '+00:00', '+08:00')) BETWEEN '" . mysqli_real_escape_string($conn, $fromDate) . "' AND '" . mysqli_real_escape_string($conn, $toDate) . "'";
...
// I. Revenue
$revenueSql = "SELECT COALESCE(SUM(p.amount), 0) as total FROM payments p LEFT JOIN users u ON p.patient_id = u.id WHERE $payConditions";
...
// Convert UTC timestamps to Manila timezone (UTC+8) before filtering
$apptSql = "SELECT COUNT(*) as total FROM appointments WHERE DATE(CONVERT_TZ(appointment_date, '+00:00', '+08:00')) BETWEEN '" . mysqli_real_escape_string($conn, $fromDate) . "' AND '" . mysqli_real_escape_string($conn, $toDate) . "'";
...
// Convert UTC timestamps to Manila timezone (UTC+8) before filtering
$patSql = "SELECT COUNT(DISTINCT a.patient_id) as total FROM appointments a WHERE DATE(CONVERT_TZ(a.appointment_date, '+00:00', '+08:00')) BETWEEN '" . mysqli_real_escape_string($conn, $fromDate) . "' AND '" . mysqli_real_escape_string($conn, $toDate) . "'";
