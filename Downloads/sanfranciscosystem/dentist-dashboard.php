...
if ($columnExists && mysqli_num_rows($columnExists) > 0) {
    $profileQuery = mysqli_query($conn, "SELECT profile_picture FROM patient_profiles WHERE user_id = '$dentistID'");
    if ($profileQuery) {
...
<head>
    ...
    <meta charset="utf-8"/>
    <title>Dentist Dashboard - San Nicolas Dental Clinic</title>
        ...
        <nav class="flex-1 px-4 py-4 gap-2 flex flex-col overflow-y-auto font-black">
            ...
            <a class="flex items-center gap-3 px-4 py-3 rounded-lg text-slate-600 dark:text-slate-300 hover:bg-slate-50 transition-colors" href="complaint.php">
                ...
                <?php if($notifComplaints > 0): ?>
                    <span class="ml-auto bg-red-500 text-white text-[10px] min-w-[18px] h-[18px] flex items-center justify-center rounded-full font-black"><?php echo $notifComplaints; ?></span>
                <?php endif; ?>
            </a>
            <a class="flex items-center gap-3 px-4 py-3 rounded-lg text-slate-600 dark:text-slate-300 hover:bg-slate-50 transition-colors" href="inquiry.php">
                ...
                <?php if($notifInquiries > 0): ?>
                    <span class="ml-auto bg-red-500 text-white text-[10px] min-w-[18px] h-[18px] flex items-center justify-center rounded-full font-black"><?php echo $notifInquiries; ?></span>
                <?php endif; ?>
            </a>
